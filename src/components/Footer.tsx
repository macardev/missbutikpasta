...
export default function Footer() {
  ...
  return (
    <footer className="bg-dark text-cream/70 py-12 sm:py-16" role="contentinfo">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <nav aria-label="Footer navigasyon">
            <h3 className="font-playfair font-semibold text-cream text-base mb-4">Hızlı Linkler</h3>
          ...
          <div>
            <h3 className="font-playfair font-semibold text-cream text-base mb-4">Sosyal Medya</h3>
            <div className="flex gap-4">
              <a
                ...
                className="w-10 h-10 rounded-full bg-cream/10 hover:bg-pink flex items-center justify-center transition-colors"
              >
              ...
              <a
                ...
                rel="noopener noreferrer"
                aria-label="WhatsApp"
                className="w-10 h-10 rounded-full bg-cream/10 hover:bg-green-500 flex items-center justify-center transition-colors"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
